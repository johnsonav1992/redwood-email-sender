const sendEmailsInBatches = () => {
  ...
  const emailData = range.getValues();
  const batchSize = 1;
  let sentCount = 0;
  ...
  for (let i = 1; i < emailData.length; i++) {
    ...
    const status = sheet.getRange(i + 1, 2).getValue(); // Check status in status column
...
const html = `<div id=":8f" class="ii gt" jslog="20277; u014N:xr6bB; 1:WyIjdGhyZWFkLWY6MTgxMjkwMjg2MTY5NTYyNDA2OHxtc2ctZjoxODEyOTAyODYxNjk1NjI0MDY4Il0.; 4:WyIjbXNnLWY6MTgxMjkwMjg2MTY5NTYyNDA2OCIsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLG51bGwsbnVsbCxudWxsLDBd"><div id=":8e" class="a3s aiL "><div style="line-break:after-white-space"><div class="adM"><br>
